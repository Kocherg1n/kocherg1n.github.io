...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _custom_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./custom-select */ \"./src/js/custom-select.js\");\n\ndocument.addEventListener('DOMContentLoaded', function () {\n  // Get/Set input-range value\n  var getRangeValue = function getRangeValue() {\n    var range = document.querySelector('.form__range');\n    var output = document.querySelector('.form__range-value');\n    output.innerHTML = range.value + ' %';\n\n    range.oninput = function () {\n      return output.innerHTML = range.value + ' %';\n    };\n  }; // To fix the header on the scroll\n\n\n  var headerFixed = function headerFixed() {\n    window.onscroll = function () {\n      var header = document.querySelector('.header');\n\n      if (window.pageYOffset > 70) {\n        header.classList.add('header__fixed');\n      } else {\n        header.classList.remove('header__fixed');\n      }\n    };\n  }; // Show/hide hamburger (mobile) menu\n\n\n  var getHamburger = function getHamburger() {\n    var hamburgerBtn = document.querySelector('.hamburger');\n    var hamburgerNav = document.querySelector('.hamburger-nav');\n    hamburgerBtn.addEventListener('click', function () {\n      hamburgerNav.classList.toggle('hamburger-nav--active');\n      document.body.classList.toggle('overflow-hidden');\n      hamburgerBtn.classList.toggle('hamburger--active');\n    });\n  };\n\n  getRangeValue();\n  headerFixed();\n  getHamburger();\n});\n\n//# sourceURL=webpack:///./src/js/main.js?");
